...
\begin{frontmatter}
  ...
  \title{Mask usage classification using vision transformer
    with learning transfer and data augmentation Methods\tnoteref{tnote1}}%
  \tnotetext[tnote1]{This is an example for title footnote coding.}

  \author{Hensel Jahja \corref{cor1}}
  \cortext[cor1]{Corresponding author:
    E-mail Address: \url{henseldonato@student.ub.ac.id};}
  \author{Given-name2 \snm{Surname2}\fnref{fn1}}
  \fntext[fn1]{This is author footnote for second author.}
  \author{Given-name3 \snm{Surname3}}
